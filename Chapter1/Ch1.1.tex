...
Ещё одна фундаментальная операция, которая переносится с чётких множеств на нечёткие~--- прямое (декартово) произведение. Классическое определение этой операции дано в~\cite{Zadeh_LingVar}, а в~\cite{Shtovba} с~помощью прямого произведения также вводится понятие нечёткого отношения.
\begin{mydef}
...
% Немного (чуть-чуть) про сравнение нечётких чисел (без недостатков).
